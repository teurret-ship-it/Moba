...
function arena(localClass: ClassId, seed = 1) {
  // Wariant rundy wymuszony na „zwykły": mierzymy efekty kart, a wariant
  // mnożyłby zdrowie, prędkość albo odnowienia i zafałszował każdą liczbę.
  const s = new Simulation({
    seed, playerCount: 4, humanCount: 1, localClass, modifierId: 'zwykla',
  });
  s.world.phase = 'live';
